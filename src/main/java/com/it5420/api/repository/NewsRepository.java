...
public interface NewsRepository extends MongoRepository<News, String> {
    Page<News> findByNewspaperContainingAllIgnoreCase(String newspaper, Pageable date) ; // dựa theo tên của trang báo
    Page<News> findByOrderByDateDesc(Pageable pageable) ; // lấy ra tất cả
